            ...
            <div className="auth__form">
              ...
              {googleEnabled && mode !== 'forgot' && <>
                <div className="auth__providers">
                  <button type="button" className="auth__provider auth__provider--google" onClick={() => { const returnTo = authReturnTo(window.location); window.location.assign(`/api/house/auth/google/start?returnTo=${encodeURIComponent(returnTo)}`); }}>
