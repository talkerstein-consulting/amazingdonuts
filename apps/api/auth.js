...
const cookieName = "house_session";
...
export async function createSession(pool, response, userId, tenantId, secure) {
...
export async function loadSession(pool, request) {
...
export async function logout(pool, request, response, secure) {
  const token = cookie(request);
