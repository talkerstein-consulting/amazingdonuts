...
const app=createApp({pool,square,config:{secureCookies:process.env.NODE_ENV==="production",sessionSecret:process.env.SESSION_SECRET,siteUrl:process.env.PUBLIC_SITE_URL||`http://127.0.0.1:${process.env.PORT||3101}`,googleClientId:process.env.GOOGLE_OAUTH_CLIENT_ID||"",googleClientSecret:process.env.GOOGLE_OAUTH_CLIENT_SECRET||""}});
